...
const modules = [
  {
    ...
    description:
      "Identity, history, specifications, rarity and market context in one definitive record.",
    href: "/atlas",
    icon: BookOpen,
  },
  {
    ...
    description:
      "Buy and sell against trusted catalogue data instead of guesswork and noisy listings.",
    href: "/marketplace",
    icon: Store,
  },
  {
    ...
    description:
      "Track what you own, what it is worth and what belongs in your collection next.",
    href: "/collection",
    icon: Boxes,
  },
];
    ...
    <div className="min-h-screen bg-[#050912] pb-24 text-white md:pb-0">
      ...
      <main>
        <section className="relative overflow-hidden border-b border-white/[0.06]">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_73%_25%,rgba(232,200,106,0.12),transparent_28rem)]" />
          <div className="relative mx-auto grid min-h-[780px] max-w-[1440px] items-center gap-16 px-5 py-20 lg:grid-cols-[0.94fr_1.06fr] lg:px-10 lg:py-28">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-8 text-6xl font-black leading-[0.88] tracking-[-0.075em] sm:text-7xl lg:text-[7.1rem]">
                Everything you collect.
                <span className="block text-[#e8c86a]">Finally connected.</span>
              </h1>
              <p className="mt-8 max-w-2xl text-lg leading-8 text-white/55 sm:text-xl">
                Identify, catalogue, value, organise and trade every collectible through one intelligent system.
              </p>
              ...
              <div className="mt-10 flex flex-wrap gap-x-6 gap-y-3 text-sm text-white/38">
                {["Identify", "Catalogue", "Value", "Collect", "Trade"].map((item) => (
            ...
            <div className="relative min-h-[520px] lg:min-h-[630px]">
              <div className="absolute inset-10 rounded-full bg-[#e8c86a]/10 blur-3xl" />
              <div className="absolute inset-x-0 top-8 overflow-hidden rounded-[2rem] border border-white/[0.09] bg-[#09111f]/94 shadow-[0_40px_120px_rgba(0,0,0,0.48)] backdrop-blur-xl">
                ...
                <div className="grid lg:grid-cols-[1.12fr_0.88fr]">
                  <div className="grid min-h-[330px] place-items-center border-b border-white/[0.07] bg-white/[0.018] p-8 lg:border-b-0 lg:border-r">
                  ...
                  <div className="flex flex-col justify-between p-6">
                    <div>
                      ...
                      <p className="mt-3 text-sm leading-6 text-white/42">
                        One trusted record for identity, ownership and market intelligence.
                      </p>
                    </div>
        ...
        <section className="border-b border-white/[0.06] bg-white/[0.012]">
          <div className="mx-auto max-w-[1440px] px-5 py-7 lg:px-10">
            <p className="text-center text-[10px] font-bold uppercase tracking-[0.24em] text-white/24">
              One system, built for every category
            </p>
            <div className="mt-5 flex flex-wrap justify-center gap-x-8 gap-y-3">
              {categories.map((category, index) => (
                <span
                  key={category}
                  className={index === 0 ? "text-sm font-bold text-[#e8c86a]" : "text-sm font-semibold text-white/32"}
                >
                  {category}
                </span>
              ))}
          ...
          <div className="overflow-hidden rounded-[2rem] border border-[#e8c86a]/18 bg-[#0a111d]">
            <div className="grid lg:grid-cols-[0.9fr_1.1fr]">
              <div className="flex flex-col justify-center p-8 sm:p-12 lg:p-16">
                ...
                <h2 className="mt-5 text-5xl font-black leading-[0.95] tracking-[-0.055em] sm:text-6xl">
                  A better exit for every collection.
                </h2>
                <p className="mt-6 max-w-xl text-lg leading-8 text-white/48">
                  Start with photos or a known item. TBX identifies, structures and prepares the collection for market with less effort and better information.
                </p>
            ...
            <div className="flex items-end justify-between gap-6">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-lg leading-8 text-white/42">
                  Live listings connected to trusted records, richer context and better buying decisions.
                </p>
              </div>
                  ...
                  <Link key={listing.id} href={`/marketplace/${listing.id}`} className="group overflow-hidden rounded-[1.75rem] border border-white/[0.07] bg-[#09111e] transition hover:-translate-y-1 hover:border-[#e8c86a]/25">
                    <div className="relative grid aspect-[4/3] place-items-center bg-white/[0.02] p-6">
                      ...
                      {listing.legoSet.image_url ? (
                        <img src={listing.legoSet.image_url} alt={listing.legoSet.name} className="h-full w-full object-contain transition duration-300 group-hover:scale-[1.03]" />
                      ) : (
                  ...
                  <Link key={name} href={`/atlas?q=${encodeURIComponent(name)}`} className="group flex min-h-[270px] flex-col justify-between rounded-[1.75rem] border border-white/[0.07] bg-[#09111e] p-6 transition hover:-translate-y-1 hover:border-[#e8c86a]/25">
                    <div>
                      <div className="flex items-center justify-between">
                        <span className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.17em] text-emerald-300"><span className="h-1.5 w-1.5 rounded-full bg-emerald-300" /> Watched</span>
          ...
          <div className="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            ...
            <div className="rounded-[2rem] border border-white/[0.08] bg-[#09111e] p-5 sm:p-7">
              <div className="flex items-center justify-between border-b border-white/[0.07] pb-5">
                <div><p className="text-xs font-bold uppercase tracking-[0.18em] text-white/28">My collection</p><h3 className="mt-2 text-2xl font-black tracking-[-0.04em]">Modern Icons</h3></div>
                <div className="grid h-10 w-10 place-items-center rounded-xl border border-white/[0.08] text-[#e8c86a]"><Heart className="h-4 w-4" /></div>
              </div>
              ...
              <div className="mt-5 rounded-2xl border border-white/[0.07] bg-[#070d17] p-5">
                <div className="flex items-center justify-between"><div><p className="text-xs font-bold uppercase tracking-[0.16em] text-white/25">Collection health</p><p className="mt-2 font-bold">Strong catalogue coverage</p></div><ShieldCheck className="h-6 w-6 text-emerald-300" /></div>
                <div className="mt-5 h-2 overflow-hidden rounded-full bg-white/[0.06]"><div className="h-full w-[86%] rounded-full bg-[#e8c86a]" /></div>
                <div className="mt-3 flex justify-between text-xs text-white/28"><span>86% fully catalogued</span><span>14% to review</span></div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="relative mx-auto max-w-[1440px] overflow-hidden rounded-[2rem] border border-[#e8c86a]/20 bg-[#0b1321] px-7 py-16 sm:px-12 lg:px-16 lg:py-20">
            ...
            <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
              <div className="max-w-4xl">
                <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#e8c86a]">Start with Atlas</p>
                <h2 className="mt-5 text-5xl font-black leading-[0.94] tracking-[-0.06em] sm:text-7xl">Your collection deserves a system.</h2>
                <p className="mt-6 max-w-2xl text-lg leading-8 text-white/48">Search the catalogue, create your collection and let TBX turn scattered objects into something intelligent.</p>
              </div>
              <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
                <Link href="/atlas" className="inline-flex h-14 items-center justify-center gap-3 rounded-2xl bg-[#e8c86a] px-7 font-bold text-[#050912] transition hover:-translate-y-0.5 hover:bg-[#f1d478]">Explore Atlas <ArrowRight className="h-5 w-5" /></Link>
                <Link href="/sell" className="inline-flex h-14 items-center justify-center rounded-2xl border border-white/12 px-7 font-bold text-white/75 transition hover:border-white/25 hover:text-white">Sell a collection</Link>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-white/[0.06] px-5 py-10 lg:px-10">
        <div className="mx-auto flex max-w-[1440px] flex-col gap-6 text-sm text-white/35 sm:flex-row sm:items-center sm:justify-between"><Brand /><p>The operating system for collectibles.</p></div>
      </footer>
