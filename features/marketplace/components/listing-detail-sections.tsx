  ...
  return (
    <section className="rounded-[2rem] border border-[#eadfce] bg-slate-950 p-7 text-white shadow-[0_24px_80px_rgba(15,23,42,0.16)]">
      <div className="flex items-start justify-between gap-5">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-yellow-300">Seller trust</p>
          <div className="mt-3 flex items-end gap-3"><span className="text-6xl font-semibold">{seller.trustScore}</span><span className="pb-2 text-white/50">/ 100</span></div>
